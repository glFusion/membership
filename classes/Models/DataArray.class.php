 ...
 * Uses accessor functions to safely get values from arrays, returning the
 * expected data type or a reasonable default if the key is not set.
 *
...
class DataArray implements \ArrayAccess
{
     ...
     * @return  string|null Array value, or default if not set
     */
    ...
    /**
     * Get an integer value from the array.
     * Default may be NULL.
     *
     * @param   string      $var    Key name
     * @param   int|null    $default    Default value if not found
     * @return  int|null    Array value, or default if not set
     */
    ...
    /**
     * Get a floating-point value from the array.
     * Default may be NULL.
     *
     * @param   string      $var    Key name
     * @param   float|null  $default    Default value if not found
     * @return  float|null  Array value, or default if not set
     */
    ...
    /**
     * Get a boolean value from the array.
     * Default may be NULL.
     *
     * @param   string      $var    Key name
     * @param   bool|null   $default    Default value if not found
     * @return  bool|null   Array value, empty array if undefined
     */
     ...
     *
     * @param   string      $var    Key name
     * @param   array|null   $default    Default value if not found
     * @return  array|null  Array value, empty array if undefined
     */
